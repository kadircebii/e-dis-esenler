        ...
        <div class="container">
            <div class="row mb-minus-30">
                <div class="col-xl-4 col-md-6">
                    <div class="team__item team__item-doctor_page team__item-box_shadow mb-30">
                        <div class="team__item-media">
                            <img class="img-fluid" src="assets/imgs/doctor-page/doctor-1.jpg" alt="image not found">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="team__item team__item-doctor_page team__item-box_shadow mb-30">
                        <div class="team__item-media">
                            <img class="img-fluid" src="assets/imgs/doctor-page/doctor-2.jpg" alt="image not found">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="team__item team__item-doctor_page team__item-box_shadow mb-30">
                        <div class="team__item-media">
                            <img class="img-fluid" src="assets/imgs/doctor-page/doctor-3.jpg" alt="image not found">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="team__item team__item-doctor_page team__item-box_shadow mb-30">
                        <div class="team__item-media">
                            <img class="img-fluid" src="assets/imgs/doctor-page/doctor-4.jpg" alt="image not found">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="team__item team__item-doctor_page team__item-box_shadow mb-30">
                        <div class="team__item-media">
                            <img class="img-fluid" src="assets/imgs/doctor-page/doctor-5.jpg" alt="image not found">
                        </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="team__item team__item-doctor_page team__item-box_shadow mb-30">
                        <div class="team__item-media">
                            <img class="img-fluid" src="assets/imgs/doctor-page/doctor-6.jpg" alt="image not found">
                        </div>
